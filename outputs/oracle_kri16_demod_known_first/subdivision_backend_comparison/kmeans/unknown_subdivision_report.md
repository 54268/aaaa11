...
| 指标键 | 中文说明 | 数值 |
| --- | --- | ---: |
| method | 聚类协议 | unknown_only_kmeans |
| clustering_backend | 聚类后端 | kmeans |
...
| m_selection_score | m 无监督诊断评分 | 0.764000 |
| m_selection_offline_quality | 离线细分质量均值 | 0.882082 |
| m_selection_offline_adjusted_quality | 覆盖率修正后的离线细分质量 | 0.853047 |
...
| cluster_size_min | 最小细分类样本数 | 3721 |
| cluster_size_max | 最大细分类样本数 | 4110 |
| cluster_size_mean | 平均细分类样本数 | 3896.333333 |
| nearest_known_proto_distance_mean | 到最近已知原型的平均距离 | 0.546078 |
| nearest_known_proto_distance_min | 到最近已知原型的最小距离 | 0.131498 |
| nmi | 归一化互信息，越高表示聚类与真实未知类越一致 | 0.852434 |
| ari | 调整兰德指数，越高表示聚类与真实未知类越一致 | 0.832207 |
| purity | 纯度，每个聚类中主导真实类的占比 | 0.921844 |
| hungarian_accuracy | 匈牙利匹配后的聚类准确率 | 0.921844 |
| unknown_cache_precision | unknown cache 中真实未知样本占比 | 0.992814 |
| unknown_cache_recall | 真实未知样本进入 unknown cache 的比例 | 0.967083 |
| coverage_of_total_test_unknown | 完成细分的真实未知样本覆盖率 | 0.967083 |
