...
| m_selection_score | m 无监督诊断评分 | 1.309752 |
...
| selected_unknown_cache_size | 进入 unknown cache 的样本数 | 9640 |
...
| cluster_size_mean | 平均细分类样本数 | 803.333333 |
| nearest_known_proto_distance_mean | 到最近已知原型的平均距离 | 0.377503 |
| nearest_known_proto_distance_min | 到最近已知原型的最小距离 | 0.042816 |
...
| unknown_cache_precision | unknown cache 中真实未知样本占比 | 0.995851 |
