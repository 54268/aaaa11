...
| resolved_num_clusters | 自动确定的未知细分类数 | 13 |
...
| m_selection_score | m 无监督诊断评分 | -4.115717 |
| m_selection_offline_quality | 离线细分质量均值 | 0.982121 |
| m_selection_offline_adjusted_quality | 覆盖率修正后的离线细分质量 | 0.975676 |
...
| uncertain_size | 未分配/不确定样本数 | 63 |
| uncertain_ratio | 未分配/不确定样本比例 | 0.006539 |
| cluster_size_min | 最小细分类样本数 | 349 |
| cluster_size_max | 最大细分类样本数 | 807 |
| cluster_size_mean | 平均细分类样本数 | 736.230769 |
| nearest_known_proto_distance_mean | 到最近已知原型的平均距离 | 0.379114 |
| nearest_known_proto_distance_min | 到最近已知原型的最小距离 | 0.040442 |
| nmi | 归一化互信息，越高表示聚类与真实未知类越一致 | 0.987505 |
| ari | 调整兰德指数，越高表示聚类与真实未知类越一致 | 0.978830 |
| purity | 纯度，每个聚类中主导真实类的占比 | 0.999371 |
| hungarian_accuracy | 匈牙利匹配后的聚类准确率 | 0.962777 |
| unknown_cache_precision | unknown cache 中真实未知样本占比 | 0.996471 |
| unknown_cache_recall | 真实未知样本进入 unknown cache 的比例 | 1.000000 |
| coverage_of_total_test_unknown | 完成细分的真实未知样本覆盖率 | 0.993437 |
