...
本报告汇总 `Comparison method/adapted_baselines/run_comparison.py` 的 formal 结果。论文正文采用精简口径：开放集拒识只汇总 `unknown_recall`、`known_accuracy`、`macro_f1` 和 `oscr`；未知类细分只汇总 `nmi`、`ari`、`hungarian_accuracy` 和覆盖率。
...
| PCBM (ours) | 1.000000 | 0.983594 | 0.992021 | 0.983559 |
