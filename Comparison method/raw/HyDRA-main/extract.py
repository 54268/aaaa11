...
# Step 5: Save the extracted features and labels into the files
...
save_processed_data(dataset_path, 'iq_ManyTx.pkl', X_train, y_train, X_val, y_val, X_test, y_test, class_weights, {'Type:':'iq', 'k':2})