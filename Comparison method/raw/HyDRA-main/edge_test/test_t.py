...
import pickle
from HyDRA_T import ResConv1d, CNNFeatureExtractor, PositionalEncoding, TransformerEncoderModel, ClassificationHead, CNNTransformerModel
...
if __name__ == "__main__":
    # 设置参数（根据你的模型调整这些值）
    model_path = r"/home/qiu/桌面/RF-fingerprint-classification/edge_test/model_lossless_iq_3_SingleDay_T.pkl"
