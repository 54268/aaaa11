...
dataset_path = '/home/qiu/桌面/RF-fingerprint-classification/New Data/'               # Directory containing the compact dataset
dataset_name = 'ManyTx'                # Name of the pickle file (without .pkl)
