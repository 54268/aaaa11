...
tx_list = ['tx1', 'tx2', 'tx3', 'tx4', 'tx5']  # List of transmitter names
rx_list = ['rx1', 'rx2']                        # List of receiver names
capture_date_list = ['date1', 'date2', 'date3'] # List of capture dates
equalized = 0                                   # 0 for non-equalized, 1 for equalized
dataset_path = 'path/to/dataset/'               # Directory containing the compact dataset
dataset_name = 'compact_dataset'                # Name of the pickle file (without .pkl)
