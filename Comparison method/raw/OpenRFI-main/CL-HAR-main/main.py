...
parser.add_argument('--dataset', type=str, default='RF_mini_10', choices=['RF_mini_10'], help='name of dataset')
...
parser.add_argument('--height', type=int, default=2, help='name of rf signal height')
parser.add_argument('--width', type=int, default=1024, help='name of rf signal length')
parser.add_argument('--transformer_embedding_size', type=int, default=64, help='name of transformer_embedding_size')



parser.add_argument('--aug1', type=str, default='jit_scal',
                    choices=['na', 'noise', 'scale', 'negate', 'perm', 'shuffle', 't_flip', 't_warp', 'resample', 'rotation', 'perm_jit', 'jit_scal', 'hfc', 'lfc', 'p_shift', 'ap_p', 'ap_f', 'same', 'repeat','awgn','noise_RF','perm_jit_RF'],
...
parser.add_argument('--backbone', type=str, default='DCL', choices=['FCN', 'DCL', 'LSTM', 'AE', 'CNN_AE', 'Transformer','RoInformer'], help='name of backbone network')
