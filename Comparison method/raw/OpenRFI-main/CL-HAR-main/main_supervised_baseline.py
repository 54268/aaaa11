...
parser.add_argument('--dataset', type=str, default='ucihar', choices=['oppor', 'ucihar', 'shar', 'hhar','RF','RF_mini',"ucihar_test","RF_mini_10"], help='name of dataset')
...
parser.add_argument('--backbone', type=str, default='DCL', choices=['FCN', 'DCL', 'LSTM', 'AE', 'CNN_AE', 'Transformer',"RoInformer"], help='name of framework')
...
if __name__ == '__main__':
    ...
    if args.backbone == 'FCN':
        ...
        model = RoInformer(n_channels=args.n_feature, len_sw=args.len_sw, n_classes=args.n_class, dim=128,heads=4,d_ff=512, dropout=0.1, backbone=False)
    else:
        NotImplementedError
    ...
    if args.backbone == 'FCN':
        ...
        model_test = RoInformer(n_channels=args.n_feature, len_sw=args.len_sw, n_classes=args.n_class, dim=128,heads=4,d_ff=512, dropout=0.1, backbone=False)
    else:
        NotImplementedError
