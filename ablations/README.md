...
2. `MBS-Calib`: ordinary marginal boundary samples only, with the same supervised calibrator structure; WiSig uses a weak ordinary-MBS setting to isolate the effect before adding PCBS.
