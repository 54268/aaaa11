...
- 输出目录：`D:\learn_pytorch\笔记\方案\os_sei_code\ablations\01_模块消融\oracle\full_method`
...
| macro_f1 | 宏平均 F1 | 0.927271 | 每个类别 F1 的平均值，更关注类别均衡表现，越高越好。 |
...
| 指标键 | 中文名 | 数值 | 说明 |
| --- | --- | ---: | --- |
| macro_precision | 宏平均精确率 | 0.977128 | 每个类别 precision 的平均值，越高越好。 |
| macro_recall | 宏平均召回率 | 0.884148 | 每个类别 recall 的平均值，越高越好。 |
| weighted_f1 | 加权 F1 | 0.963348 | 按类别样本数加权后的 F1，越高越好。 |
...
| oscr | 开放集分类识别曲线面积 | 0.871013 | 同时考虑已知类分类正确率和未知拒识能力的综合面积，越高越好。 |
...
- 图表目录：D:\learn_pytorch\笔记\方案\os_sei_code\ablations\01_模块消融\oracle\full_method\figures
