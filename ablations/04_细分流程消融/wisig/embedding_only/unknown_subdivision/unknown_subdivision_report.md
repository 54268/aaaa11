...
| m_selection_score | m 无监督诊断评分 | 1.330805 |
| m_selection_offline_quality | 离线细分质量均值 | 0.998689 |
| m_selection_offline_adjusted_quality | 覆盖率修正后的离线细分质量 | 0.998689 |
...
| cluster_size_min | 最小细分类样本数 | 800 |
| cluster_size_max | 最大细分类样本数 | 816 |
| cluster_size_mean | 平均细分类样本数 | 806.250000 |
