...
| m_selection_score | m 无监督诊断评分 | 1.076112 |
| m_selection_offline_quality | 离线细分质量均值 | 0.852121 |
| m_selection_offline_adjusted_quality | 覆盖率修正后的离线细分质量 | 0.852121 |
...
| cluster_size_min | 最小细分类样本数 | 580 |
| cluster_size_max | 最大细分类样本数 | 1217 |
...
| nmi | 归一化互信息，越高表示聚类与真实未知类越一致 | 0.890550 |
| ari | 调整兰德指数，越高表示聚类与真实未知类越一致 | 0.798350 |
| purity | 纯度，每个聚类中主导真实类的占比 | 0.859792 |
| hungarian_accuracy | 匈牙利匹配后的聚类准确率 | 0.859792 |
