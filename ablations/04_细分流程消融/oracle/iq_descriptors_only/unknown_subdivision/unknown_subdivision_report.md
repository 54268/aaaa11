...
| m_selection_score | m 无监督诊断评分 | 1.135369 |
| m_selection_offline_quality | 离线细分质量均值 | 0.680392 |
| m_selection_offline_adjusted_quality | 覆盖率修正后的离线细分质量 | 0.644247 |
...
| cluster_size_min | 最小细分类样本数 | 3249 |
| cluster_size_max | 最大细分类样本数 | 4240 |
| cluster_size_mean | 平均细分类样本数 | 3840.000000 |
| nearest_known_proto_distance_mean | 到最近已知原型的平均距离 | 0.549230 |
| nearest_known_proto_distance_min | 到最近已知原型的最小距离 | 0.044978 |
| nmi | 归一化互信息，越高表示聚类与真实未知类越一致 | 0.744879 |
| ari | 调整兰德指数，越高表示聚类与真实未知类越一致 | 0.608505 |
| purity | 纯度，每个聚类中主导真实类的占比 | 0.688933 |
| hungarian_accuracy | 匈牙利匹配后的聚类准确率 | 0.679252 |
| unknown_cache_precision | unknown cache 中真实未知样本占比 | 0.985241 |
| unknown_cache_recall | 真实未知样本进入 unknown cache 的比例 | 0.965167 |
| coverage_of_total_test_unknown | 完成细分的真实未知样本覆盖率 | 0.946875 |
