...
| m_selection_score | m 无监督诊断评分 | 0.614453 |
| m_selection_offline_quality | 离线细分质量均值 | 0.799749 |
| m_selection_offline_adjusted_quality | 覆盖率修正后的离线细分质量 | 0.773424 |
...
| cluster_size_min | 最小细分类样本数 | 82 |
| cluster_size_max | 最大细分类样本数 | 7778 |
...
| nmi | 归一化互信息，越高表示聚类与真实未知类越一致 | 0.853374 |
| ari | 调整兰德指数，越高表示聚类与真实未知类越一致 | 0.751999 |
| purity | 纯度，每个聚类中主导真实类的占比 | 0.797372 |
| hungarian_accuracy | 匈牙利匹配后的聚类准确率 | 0.796252 |
