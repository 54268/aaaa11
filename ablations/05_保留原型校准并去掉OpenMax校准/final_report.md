...
- 数据集：`wisig_compact`
- 配置文件：`D:\learn_pytorch\笔记\方案\os_sei_code\experiments\ablations\05_保留原型校准并去掉OpenMax校准\config.yaml`
- 输出目录：`D:\learn_pytorch\笔记\方案\os_sei_code\experiments\ablations\experiments\ablations\05_保留原型校准并去掉OpenMax校准`
...
- 图表目录：D:\learn_pytorch\笔记\方案\os_sei_code\experiments\ablations\experiments\ablations\05_保留原型校准并去掉OpenMax校准\figures
